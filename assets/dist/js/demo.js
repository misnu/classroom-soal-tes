...
(function ($) {
  ...
  // setTimeout(function () {
  //   if (window.___browserSync___ === undefined && Number(localStorage.getItem('default_style:Demo:MessageShowed')) < Date.now()) {
  //     localStorage.setItem('default_style:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
  //     // eslint-disable-next-line no-alert
  //     alert('You load default_style\'s "demo.js", \nthis file is only created for testing purposes!')
  //   }
  // }, 1000)
  ...
  $container.append(
    '<h5>Customize default_style</h5><hr class="mb-2"/>'
  )

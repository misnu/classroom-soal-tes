/*!
 * default_style v3.2.0 (https://default_style.io)
 * Copyright 2014-2022 Colorlib <https://colorlib.com>
 * Licensed under MIT (https://github.com/ColorlibHQ/default_style/blob/master/LICENSE)
 */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jquery')) :
  typeof define === 'function' && define.amd ? define(['exports', 'jquery'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.default_style = {}, global.jQuery));
  ...
  /**
   * --------------------------------------------
   * default_style ControlSidebar.js
   * License MIT
   * --------------------------------------------
   */
  /**
  ...
  /**
   * --------------------------------------------
   * default_style ExpandableTable.js
   * License MIT
   * --------------------------------------------
   */
  /**
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config) {
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('default_style:IFrame:Options', JSON.stringify(_options));
        ...
        new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('default_style:IFrame:Options')))._initFrameElement();
      }
    };
  ...
  /**
   * --------------------------------------------
   * default_style SidebarSearch.js
   * License MIT
   * --------------------------------------------
   */
  /**
...
//# sourceMappingURL=default_style.js.map
